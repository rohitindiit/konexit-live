            ...
            <div class="layout-px-spacing">
               <div class="row layout-top-spacing">
                  <div class="col-xl-7 col-12 px-2 d-flex mb-3 ">
                     <a href="{{url('/')}}/submissions" class="mr-3 mt-1"><img src="{{url('/')}}/resources/views/Admin/assets/img/backarrow.svg"/></a>				     
                     <div>
                              ...
                              <div class="col-md-6 text-right">
                                 <div class="formmediaimg">
                                    ...
                                    <div>
                                       ...
                                       @if($count > 0)
                                       <a href="{{url('/submission_media/'.$submissions->id)}}"> <span class="count-media">{{$count}}</span> <span  class="media-arrow"><img src="{{url('/')}}/resources/views/organization/assets/img/arrow-right.svg"/></span></a>
                                      @endif
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="widget">
                        <div class="widget-content">
                           ...
                           <div class="comments">
                                    ...
                                    <h5>{{App\Models\User::where('id','=',$comment->comment_by)->pluck('name')->implode('')}} {{App\Models\User::where('id','=',$comment->comment_by)->pluck('lname')->implode('')}}<span style="float:right;color:#dfe5ec">{{date('j M Y', strtotime($comment->created_at))}} {{date('g:i A', strtotime($comment->created_at))}}</span></h5>
                                    <p>{{$comment->comment}}</p>
                           ...
                           <!-- <div cl ass="commentsform">
                              <div class="row">
                                 ...
                                 <div class="col-md-3 col-lg-2">
                                    ...
                                    <button class="btn btn-primary h-44 w-100">Submit</button>
                                 </div>
                              </div>
                           </div> -->
                        </div>
