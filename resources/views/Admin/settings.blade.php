                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter First Name" value="Sonam"/>
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control" placeholder="Enter Last Name" value="Patil"/>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label>Email</label>
                                          <input type="email" class="form-control" placeholder="Enter Email" value="sonam21patil@gmail.com"/>
                                       </div>
                                       <div class="form-group">
                                          <button class="btn btn-height btn-primary mt-3">
                                          Save
                                          </button>
                                       </div>
                                    </div>
                              ...
                              <div class="tab-pane fade" id="changepassword" role="tabpanel" aria-labelledby="changepassword-tab">
                                 <div class="row  p-5">
                                    <div class="col-lg-8 offset-lg-2">
                                       ...
                                       <button class="btn btn-primary  mt-3 btn-height">
                                       Save
                                       </button>
                                    </div>
                                 </div>
