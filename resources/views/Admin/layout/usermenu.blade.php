 <ul class="navbar-item flex-row search-ul">
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
               <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                  ...
                  <span class="userimg  mr-2"><img src="{{\Config::get('site_vars.profile.profile')}}" class="img-fluid profileclass" alt="avatar"></span>  <span class="profilename">{{\Config::get('site_vars.profile.name')}} <img class="ml-1" src="{{url('/')}}/resources/views/Admin/assets/img/arrow-down.svg"/></span>
                  </a>
