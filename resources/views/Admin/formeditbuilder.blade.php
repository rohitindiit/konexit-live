...
<html lang="en">
  ...
  <body class="sidebar-noneoverflow">
    ...
    <div class="main-container" id="container">
      <input type="hidden" name="formid" id="formid" value="{{$forms->id}}">
      ...
      <div id="content" class="main-content ml-0">
        <div class="layout-px-spacing">
          <div class="row layout-top-spacing px-2">
            <div class="col-md-12">
               <form action="{{ route('edit.form') }}" method="POST" id="formform" onsubmit="return false">
                @csrf
              </form>
              <div id="builder"></div>
            </div>
...
selectboxes:{
    ...
    submitautoform2(builder.schema,'formform');
  });
