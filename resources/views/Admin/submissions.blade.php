                                    ...
                                    <div class="col-md-6">
                                       <div class="dropdown filterdrop">
                                          ...
                                          <div class="dropdown-menu position-absolute designable-css" aria-labelledby="dropdownMenuLink104">
                                            <form action="{{ url('/submissions') }}" method="GET"  id="searchform" >
                                             <h2>Filters</h2>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="btn-bottom text-left mt-4">
                                                <a href="{{route('admin.submissions')}}" class="btn btn-secondary btn-outline-secondary click_change" type="reset">Reset</a>
                              ...
                              <table class="table"  id="example">
                                 <thead>
                                    <tr>
                                       ...
                                       <th>
                                          <div class="th-content">Comments</div>
                                       </th>
                                       <th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="map mb-2" style="height: 300px; border: 2px solid #d3c5c5;">
...
$(document).ready(function() {
    ...
    $('.radiobtn02').change(function() {
        var radioButtonValue = $(this).val(); // Get the selected radio button value
        var submissionId = $(this).attr('name').replace('radiobtn02', ''); // Extract the submission ID from the radio button name
    ...
    $('.apply-button').click(function() {
        // Find the corresponding radio button within the dropdown
        var radioButton = $(this).siblings('.radiobtn2').find('.radiobtn02:checked');

        if (radioButton.length > 0) {
            radioButton.trigger('change'); // Trigger the radio button change event
        } else {
            ...
            success: function(response) {
              ...
              $.each(data, function( index, value ) {
                      console.log(value.comment_by );
                       $("#display-section").append("<div style='padding: 10px 0px;margin-bottom:10px;border-bottom: 1px solid #ced4da;'><div class='d-flex align-items-center justify-content-between mb-1'><h6 class='mb-1'><b>"+value.name+"</b></h6><span id='sp' style='opacity:0.75;font-size: 12px;color:#515365'>"+value.created_at+"</span></div><p>"+value.comment+"</p></div>");
                    });
