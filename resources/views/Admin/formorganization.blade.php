                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="row pad-lr-10">
                                                   <div class="col-md-6 px-1">
                                                      <div class="daterange">
                                                         <span>From</span>
                                                         <input id="basicFlatpickr1" value="08 Sep 2022" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                                      </div>
                                                   </div>
                                                   <div class="col-md-6 px-1">
                                                      <div class="daterange">
                                                         <span>To</span>
                                                         <input id="basicFlatpickr2" value="26 Sep 2022" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                  ...
                  <div class="modal-inner mb-3">
                     <div class="form-group">
                       <!--  <input type="text" class="assigninputs" value="" data-role="tagsinput" placeholder="Search for user" /> -->
                        ...
                        data-server="{{url('/search-userss/'.$orgid)}}" 
