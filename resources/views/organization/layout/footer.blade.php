...
<div id="exampleModal2" class="modal fade">
 ...
 <script src="{{url('/')}}/resources/views/organization/assets/js/libs/jquery-3.1.1.min.js"></script>
      ...
      <script src="{{url('/')}}/resources/views/organization/assets/css/perfect-scrollbar/perfect-scrollbar.min.js"></script>
      <script src="{{url('/')}}/resources/views/organization/assets/js/organization.js"></script>
      <script src="{{url('/')}}/resources/views/organization/assets/js/app.js"></script>
      <script src="{{url('/')}}/resources/js/validation.js"></script>
      <script src="{{url('/')}}/resources/views/organization/assets/js/form-validations.js"></script>
      ...
      <script src="{{url('/')}}/resources/views/organization/assets/js/custom.js"></script>
      <script src="{{url('/')}}/resources/views/organization/assets/js/apex/apexcharts.min.js"></script>
      <script src="{{url('/')}}/resources/views/organization/assets/js/dash_1.js"></script>
      <script>
         $(document).on('click', '.dropdown.downloaddrop .dropdown-menu', function (e) {
          e.stopPropagation();
         });
      </script>
      <script type="text/javascript" src="{{url('/')}}/resources/views/organization/assets/js/moment.min.js"></script>
      <script type="text/javascript" src="{{url('/')}}/resources/views/organization/assets/js/daterangepicker.min.js"></script>
      <script type="text/javascript">
       ...
       @if(Route::is('organization.submission_media'))
     ...
     @endif
       ...
       @if(request()->is('organization/forms') || request()->is('organization/submissions'))
