            ...
            <div class="layout-px-spacing">
               <div class="row layout-top-spacing">
                  <div class="col-xl-7 col-12 px-2 d-flex mb-3 ">
                     <a href="{{url('/')}}/organization/submissionsdetails/{{$submissions->id}}" class="mr-3 mt-1"><img src="{{url('/')}}/resources/views/Admin/assets/img/backarrow.svg"/></a>				     
                     <div>
                        ...
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item"><a href="{{url('/')}}/organization/submissionsdetails/{{$submissions->id}}">Submissions Details</a></li>
                              ...
                              <div class="col-md-12 mb-3">
                                 <div class="formgroup submittedata">
                                    ...
                                    <div class="box" style="opacity:1">
                                      <img class="smallimage" src="{{$f}}" alt="image1" style="cursor:pointer">
                                    </div>
                                   @endforeach
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">submission media</h4>
